            ...
            <TabsContent value="general">
              ...
              <Card className="mt-6">
                <CardHeader>
                  ...
                  <CardDescription>
                    Оновлює код застосунку до останньої версії: інтерфейс, тексти, логіку та логотипи всередині.
                    <br />
                    <span className="text-xs text-muted-foreground">
                      Зверніть увагу: іконку на робочому столі телефона кешує операційна система —
                      щоб оновити саме її, потрібно видалити застосунок і встановити заново.
                    </span>
                  </CardDescription>
                </CardHeader>
                <CardContent>
