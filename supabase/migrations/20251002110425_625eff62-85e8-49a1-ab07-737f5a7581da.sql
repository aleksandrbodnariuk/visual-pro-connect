...
CREATE TYPE public.app_role AS ENUM ('admin', 'founder', 'shareholder', 'user');
...
-- Step 4: Migrate existing roles from users table to user_roles
...
-- Step 6: Create helper function to check if user is admin (admin or founder)
...
-- Step 7: Update check_admin_access function
...
-- Step 8: Update is_admin function
